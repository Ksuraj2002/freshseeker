...
export interface JobStore {
  list(status?: JobStatus | 'all'): Promise<JobRecord[]>;
  create(input: JobInput): Promise<JobRecord>;
  setStatus(id: string, status: JobStatus): Promise<JobRecord | null>;
...
function createMongoStore(): JobStore {
  return {
    async list(status = 'all') {
